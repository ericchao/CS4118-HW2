...
main(int argc, char *argv[])
{
  ...
  13:	c7 44 24 04 7e 07 00 	movl   $0x77e,0x4(%esp)
  1a:	00 
  1b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  22:	e8 d9 03 00 00       	call   400 <printf>
    exit();
  27:	e8 7c 02 00 00       	call   2a8 <exit>
  ...
  3d:	e8 c6 02 00 00       	call   308 <link>
  42:	85 c0                	test   %eax,%eax
  44:	78 0a                	js     50 <main+0x50>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  46:	e8 5d 02 00 00       	call   2a8 <exit>
  4b:	90                   	nop
  ...
  5a:	c7 44 24 04 91 07 00 	movl   $0x791,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38a:	f7 f7                	div    %edi
 38c:	0f b6 92 ac 07 00 00 	movzbl 0x7ac(%edx),%edx
...
putc(int fd, char c)
{
 ...
 600:	e9 30 fe ff ff       	jmp    435 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 605:	bf a5 07 00 00       	mov    $0x7a5,%edi
...
free(void *ap)
{
 ...
 611:	a1 c8 07 00 00       	mov    0x7c8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 65f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 661:	a3 c8 07 00 00       	mov    %eax,0x7c8
}
 666:	5b                   	pop    %ebx
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 ...
 68b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 68d:	a3 c8 07 00 00       	mov    %eax,0x7c8
}
 692:	5b                   	pop    %ebx
 693:	5e                   	pop    %esi
 694:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6ac:	8b 0d c8 07 00 00    	mov    0x7c8,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6d8:	3b 05 c8 07 00 00    	cmp    0x7c8,%eax
 ...
 6f7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6fa:	89 0d c8 07 00 00    	mov    %ecx,0x7c8
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 73c:	e8 cf fe ff ff       	call   610 <free>
  return freep;
 741:	8b 0d c8 07 00 00    	mov    0x7c8,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 754:	eb a4                	jmp    6fa <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 c8 07 00 00 c0 	movl   $0x7c0,0x7c8
 75d:	07 00 00 
    base.s.size = 0;
 760:	b9 c0 07 00 00       	mov    $0x7c0,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 765:	c7 05 c0 07 00 00 c0 	movl   $0x7c0,0x7c0
 76c:	07 00 00 
    base.s.size = 0;
 76f:	c7 05 c4 07 00 00 00 	movl   $0x0,0x7c4
 776:	00 00 00 
