...
bootmain(void)
{
  ...
  if(elf->magic != ELF_MAGIC)
    ...
    7d62:	45 4c 46 
    7d65:	75 69                	jne    7dd0 <bootmain+0x9a>
  ...
  for(; ph < eph; ph++) {
    ...
    7d84:	73 3e                	jae    7dc4 <bootmain+0x8e>
    va = (uchar*)(ph->va & 0xFFFFFF);
    7d86:	8b 73 08             	mov    0x8(%ebx),%esi
    7d89:	81 e6 ff ff ff 00    	and    $0xffffff,%esi
    readseg(va, ph->filesz, ph->offset);
    7d8f:	8b 43 04             	mov    0x4(%ebx),%eax
    7d92:	89 44 24 08          	mov    %eax,0x8(%esp)
    7d96:	8b 43 10             	mov    0x10(%ebx),%eax
    7d99:	89 44 24 04          	mov    %eax,0x4(%esp)
    7d9d:	89 34 24             	mov    %esi,(%esp)
    7da0:	e8 49 ff ff ff       	call   7cee <readseg>
    if(ph->memsz > ph->filesz)
    7da5:	8b 4b 14             	mov    0x14(%ebx),%ecx
    7da8:	8b 43 10             	mov    0x10(%ebx),%eax
    7dab:	39 c1                	cmp    %eax,%ecx
    7dad:	76 0d                	jbe    7dbc <bootmain+0x86>
}
...
stosb(void *addr, int data, int cnt)
{
  asm volatile("cld; rep stosb" :
    7daf:	8d 3c 06             	lea    (%esi,%eax,1),%edi
    7db2:	29 c1                	sub    %eax,%ecx
  ...
  eph = ph + elf->phnum;
  for(; ph < eph; ph++) {
    7dbc:	83 c3 20             	add    $0x20,%ebx
    7dbf:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
    7dc2:	77 c2                	ja     7d86 <bootmain+0x50>
  ...
  entry = (void(*)(void))(elf->entry & 0xFFFFFF);
    7dc4:	a1 18 00 01 00       	mov    0x10018,%eax
  entry();
    7dc9:	25 ff ff ff 00       	and    $0xffffff,%eax
    7dce:	ff d0                	call   *%eax
}
    7dd0:	83 c4 2c             	add    $0x2c,%esp
    7dd3:	5b                   	pop    %ebx
    7dd4:	5e                   	pop    %esi
    7dd5:	5f                   	pop    %edi
    7dd6:	5d                   	pop    %ebp
