  ...
  50:	74 7a                	je     cc <forktest+0x9c>
{
  ...
  92:	c7 44 24 04 32 04 00 	movl   $0x432,0x4(%esp)
  99:	00 
  ...
  b7:	00 
  b8:	c7 44 24 04 40 04 00 	movl   $0x440,0x4(%esp)
  bf:	00 
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
  d1:	c7 44 24 04 0b 04 00 	movl   $0x40b,0x4(%esp)
  d8:	00 
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
  ea:	c7 44 24 04 1f 04 00 	movl   $0x41f,0x4(%esp)
  f1:	00 
