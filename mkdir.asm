...
main(int argc, char *argv[])
{
  ...
  42:	c7 44 24 04 95 07 00 	movl   $0x795,0x4(%esp)
  49:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    printf(2, "Usage: mkdir files...\n");
  60:	c7 44 24 04 7e 07 00 	movl   $0x77e,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38a:	f7 f7                	div    %edi
 38c:	0f b6 92 b8 07 00 00 	movzbl 0x7b8(%edx),%edx
...
putc(int fd, char c)
{
 ...
 600:	e9 30 fe ff ff       	jmp    435 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 605:	bf b1 07 00 00       	mov    $0x7b1,%edi
...
free(void *ap)
{
 ...
 611:	a1 d4 07 00 00       	mov    0x7d4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 65f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 661:	a3 d4 07 00 00       	mov    %eax,0x7d4
}
 666:	5b                   	pop    %ebx
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 ...
 68b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 68d:	a3 d4 07 00 00       	mov    %eax,0x7d4
}
 692:	5b                   	pop    %ebx
 693:	5e                   	pop    %esi
 694:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6ac:	8b 0d d4 07 00 00    	mov    0x7d4,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6d8:	3b 05 d4 07 00 00    	cmp    0x7d4,%eax
 ...
 6f7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6fa:	89 0d d4 07 00 00    	mov    %ecx,0x7d4
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 73c:	e8 cf fe ff ff       	call   610 <free>
  return freep;
 741:	8b 0d d4 07 00 00    	mov    0x7d4,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 754:	eb a4                	jmp    6fa <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 d4 07 00 00 cc 	movl   $0x7cc,0x7d4
 75d:	07 00 00 
    base.s.size = 0;
 760:	b9 cc 07 00 00       	mov    $0x7cc,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 765:	c7 05 cc 07 00 00 cc 	movl   $0x7cc,0x7cc
 76c:	07 00 00 
    base.s.size = 0;
 76f:	c7 05 d0 07 00 00 00 	movl   $0x0,0x7d0
 776:	00 00 00 
